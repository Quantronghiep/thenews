                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                                    ...
                                                    <tr>
                                                        <td style="font-size:0;height:18px;vertical-align:middle;width:18px;">
                                                            <a href="#" target="_blank"
                                                               style="color: #ea4a40; text-decoration: none;">
                                                                <img alt="instagram-logo" height="18"
                                        ...
                                        <tr>
                                            <td style="width:550px;">
                                                <img alt="welcome image" height="auto"
                                                     src="https://images.unsplash.com/photo-1593522558438-33e8435aa474?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=crop&amp;w=2250&amp;q=80"
                                                     style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:14px;"
                                                     width="550"/>
                                            </td>
                                        </tr>
                ...
                <td style="direction:ltr;font-size:0px;padding:0 40px;text-align:center;">
                    ...
                    <tr>
                        ...
                        >
                            ...
                            <table
                                align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:520px;"
                                width="520"
                            >
                                <tr>
                                    <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                            ...
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    <div
                                                        ...
                                                        <h1 style="margin: 0; font-size: 32px; line-height: 40px;">Hi
                                                            John! <br/>Thank you for signing up and welcome to Coded
                                                            Mails!</h1>
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td align="left"
                                                    ...
                                                    <div
                                                        style="font-family:Alata;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#000000;">
                                                        Click on the link below to complete your registration and get
                                                        started!
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="left" vertical-align="middle"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tbody>
                                                        <tr>
                                                            <td align="center" bgcolor="#ea4a40" role="presentation"
                                                                style="border:none;border-radius:3px;cursor:auto;mso-padding-alt:10px 25px;background:#ea4a40;"
                                                                valign="middle">
                                                                <a href="{{ route('verification.verify', ['id' => request()->user()->id , 'hash' => ]) }}"
                                                                   ...
                                                                   target="_blank">Xac thuc tai khoan</a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                          ...
                          <![endif]-->
                                                ...
                                                <td align="center"
                                                    ...
                                                    <div
                                                        ...
                                                        <a class="footer-link" href="#"
                                                           style="text-decoration: none; color: #000;">Support</a>   |  
                                                        <a class="footer-link" href="#"
                                                           style="text-decoration: none; color: #000;">Forums</a>   |
                                                         <a class="footer-link" href="#"
                                                            style="text-decoration: none; color: #000;">Contact</a>   |
                                                         <a class="footer-link" href="#"
                                                            style="text-decoration: none; color: #000;">Log In</a></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="center"
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td style="font-size:0;height:24px;vertical-align:middle;width:24px;">
                                                                            <a href="#" target="_blank"
                                                                               style="color: #ea4a40; text-decoration: none;">
                                                                                <img alt="dribbble-logo" height="24"
                                                                                     src="https://codedmails.com/images/social/black/linkedin-logo-transparent-black.png"
                                                                                     style="border-radius:3px;display:block;"
                                                                                     width="24"/>
                                                                            </a>
                                            ...
                                            <tr>
                                                <td align="center"
                                                    ...
                                                    <div
                                                        style="font-family:Alata;font-size:14px;font-weight:400;line-height:24px;text-align:center;color:#333333;">
                                                        123 Medalling Jr., Suite 100, Parrot Park, CA 12345<br/> © 2020
                                                        [Coded Mails] Inc.
                                                    </div>
                                                </td>
                                            </tr>
                                                ...
                                                <td align="center"
                                                    ...
                                                    <div
                                                        ...
                                                        Update your <a href="https://google.com"
                                                                       style="color: #ea4a40; text-decoration: none;">email
                                                            preferences</a> to choose the types of emails you receive,
                                                        or you can <a href="https://google.com"
                                                                      style="color: #ea4a40; text-decoration: none;">
                                                            unsubscribe </a>from all future emails.
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
